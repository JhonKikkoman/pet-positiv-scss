...
interface IProp {
  className?: 'service-card__link--light';
}

export default function LinkItem({ className }: IProp): React.JSX.Element {
  return (
    <a href="/" className={`service-card__link ${className ? className : ''}`}>
