...
export default function StudiesItem({ text }: IProp): React.JSX.Element {
  return (
    <li className="studies__item">
      <div className="studies__description">
        <p>{text}</p>
        <a href="/" className="studies__link">
